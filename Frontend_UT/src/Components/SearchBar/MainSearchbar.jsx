  ...
  return (
    <form className="w-full relative">
      <div className="flex mb-4 flex-col relative sm:flex-row">
        ...
        <div className="relative w-full lg:w-2/3"> {/* Add a relative container here */}
          <input
            type="text"
            placeholder="دنبال چی میگردی؟"
            className="w-full p-3 placeholder:text-gray-500 placeholder:pr-1 rounded-e-full text-black mb-3 sm:mb-0 sm:mr-0 text-right bg-slate-200"
