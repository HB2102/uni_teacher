...
const SubjectCards = ({ name, id }) => {
    ...
    const ShowMore = (id) => {
        // Ensure id is passed correctly and only called when the button is clicked
        navigate('/test', {
            state: {
                subject_id: id
            }
    ...
    return (
        <article dir='rtl' className="farmer-motion p-5 bg-white dark:bg-gray-800 rounded-lg shadow-md w-10/12 sm:w-[48%] md:w-[48%] lg:w-1/4 xl:w-1/5 mt-9">
            <div dir='rtl' className="flex items-center mb-4">
                <FaChalkboardTeacher className="w-10 h-10 ml-4" />
            ...
            <aside dir='ltr'>
                <div className="flex items-center mt-3">
                    <a
                        onClick={() => ShowMore(id)}  // Use an anonymous function to pass id
                        href="#"
