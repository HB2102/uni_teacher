...
from admin_routers import admin_university, admin_subject, admin_user, admin_teacher, admin_uni_teacher, admin_teacher_subject, admin_comment, admin_request
from general_routers import user, unversity, subject, university_teacher, teacher_subject, comment, comment_action, request
